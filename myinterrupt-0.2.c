...
void priority_schedule(void)
{
	...
	//swap(task attributes) the hightes task and put it to the current->next task
	task[my_current_task->pid].next=hig_pri;
...
void my_schedule(void)
{
    ...
    /* schedule */
  	priority_schedule();//find the hightest priority task ,and swap it to the next of current_task
